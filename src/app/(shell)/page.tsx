    ...
    <section className="relative overflow-hidden px-6 py-16 sm:px-10 lg:px-16 lg:py-24">
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <div>
          ...
          >
            <span className="h-1.5 w-1.5 rounded-full bg-primary" style={{ boxShadow: "0 0 0 3px rgba(249,125,3,.25)" }} />
            // the vedam ecosystem
          </span>
          ...
          <p className="mt-6 max-w-[30em] font-body text-base leading-relaxed text-muted sm:text-lg">
            Learn to code, predict your colleges, connect with seniors who&apos;ve walked your path,
            and join every Vedam event — all from a single account that grows with you.
          </p>
