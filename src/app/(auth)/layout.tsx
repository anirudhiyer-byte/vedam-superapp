...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  <span className="font-[family-name:var(--font-inter)] text-[46px] font-normal uppercase leading-none tracking-[-0.05em] text-white">Vedam</span>
  <span className="font-[family-name:var(--font-playfair)] text-[38px] italic leading-none tracking-tight text-white" style={{ fontWeight: 600 }}>One</span>
</div>
          {children}
        </div>
      </main>
